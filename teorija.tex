...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{C!{\vrule width 2pt}C|C|C|C}
     $\alpha$ & $\sin\alpha$ & $\kos\alpha$ & $\tan\alpha$ & $\cot\alpha$ \\ \noalign{\hrule height 2pt}
     $0\deg$  &     $0$      &      $1$     &     $0$      &   nedef.     \\ \hline
     $30\deg$ & $\frac{1}{2}$ & $\frac{\sqrt{3}}{2}$ & $\frac{\sqrt{3}}{3}$ & $\sqrt{3}$ \\ \hline
     $45\deg$ & $\frac{\sqrt{2}}{2}$ & $\frac{\sqrt{2}}{2}$ & $1$ & $1$ \\ \hline
     $60\deg$ & $\frac{\sqrt{3}}{2}$ & $\frac{1}{2}$ & $\sqrt{3}$ & $\frac{\sqrt{3}}{3}$ \\ \hline
     $90\deg$ &     $1$      & $\frac{\sqrt{3}}{2}$ & nedef. & $0$ \\
  \end{tabularx}
\end{table}
