...
\newrgbcolor{lighorange}{0.9531 0.7031 0.3125}
...
\begin{itemize*}
  ...
  \item konjugirana vrednost vsote je enaka vsoti konjugiranih vrednosti: \[ \konj{z+w} =
    \konj{z} + \konj{w}\]
...
\begin{figure}[ht]
  \begin{center}
    ...
    \subfigure[Deltoid.]{
      ...
      \begin{pspicture*}(-2,-2)(2,2)
        \pspolygon*[linecolor=pink](-1,0)(0,1)(0,0)
        \pspolygon*[linecolor=lightred](-1,0)(0,-2)(0,0)
        \pspolygon*[linecolor=pink](0,1)(1,1)(1,0)
        \pspolygon*[linecolor=lightred](1,0)(1,-2)(0,-2)
        \pspolygon(-1,0)(0,1)(1,0)(0,-2)
        \psline(-1,0)(1,0)
        \psline(0,1)(0,-2)
        \uput[u](0.5,1){$\frac{e}{2}$}
        \uput[r](1,-.5){$f$}
      \end{pspicture*}
    }
  ...
  \end{center}
  \beforecaptionskip
  \caption{Kvadrat, pravokotnik, paralelogram, deltoid in trapez.}
  \label{fig:liki:kpptd}
\end{figure}

\subsection{Trikotnik}
\label{sec:liki:trik}
%Glej sliko~\ref{fig:liki:trik}
\begin{align*}
