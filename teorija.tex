...
\[ y = GOOGLAJ KOMANDO x \iff \cot y = x, \; D_f = \R, Z_f = \left(0, \pi \right) \]
  ...
  \begin{center}
    ...
    \subfigure[Arcus sinus]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        ...
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{-1}{1}{x 90 mul sin}
      \end{pspicture*}
    }
    \subfigure[Arcus kosinus]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        \psaxes[labels=none]{->}(0,0)(-2.5,-2.5)(2.5,2.5)
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{0}{2}{x 90 mul cos}
      \end{pspicture*}
    } \\
    \subfigure[Arcus tangens]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        \psaxes[labels=none]{->}(0,0)(-2.5,-2.5)(2.5,2.5)
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{-0.9}{0.9}{x 90 mul sin x 90 mul cos div}
      \end{pspicture*}
    }
    \subfigure[Arcus kotangens]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        \psaxes[labels=none]{->}(0,0)(-2.5,-2.5)(2.5,2.5)
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{0.1}{1.9}{x 90 mul cos x 90 mul sin div}
      \end{pspicture*}
    }
    \psset{unit=1cm}
  \end{center}
...
\label{sec:enac:rac}
Racionalna enačba je vsaka enačba oblike $\frac{p(x)}{q(x)} = 0$ ali vsaka enačba, ki jo
...
tako, da določimo ničle in pole, ter tako ugotovimo predznak funkcije na celotni realni
