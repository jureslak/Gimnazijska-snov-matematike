...
\begin{figure}[ht]
  \begin{center}
      \begin{pspicture*}(-3.5,-3.5)(3.5,3.5)
        ...
        \psplot[linecolor=black, linewidth=.5pt]{-3.5}{3.5}{x -1 mul 3 exp}
        \psplot[linecolor=black, linewidth=.5pt]{-3.5}{3.5}{x 2 sub -1 mul 3 exp 1 add}
        \psline[linecolor=black, linewidth=1pt]{->}(-1,1)(1,2)
        \psline[linecolor=red, linestyle=dotted]{}(-1,1)(0,1)
        \psline[linecolor=red, linestyle=dotted]{}(-1,1)(-1,0)
        \psline[linecolor=red, linestyle=dotted]{}(1,2)(0,2)
        \psline[linecolor=red, linestyle=dotted]{}(1,2)(1,0)
        \uput[0](0,1){$y$}
        \uput[180](0,2){$y'$}
        \uput[-90](-1,0){$x$}
        \uput[-90](1,0){$x'$}
...
\begin{figure}[ht]
  \begin{center}
    \subfigure[Parameter $a$.]{
      ...
      \begin{pspicture*}(-3.5,-3.5)(3.5,3.5)
        \psaxes[labels=none]{->}(0,0)(-3.5,-3.5)(3.5,3.5)
        \psplot[linecolor=black, linewidth=1pt]{-3.5}{3.5}{x 2 exp}
        \psplot[linecolor=blue, linewidth=1pt]{-3.5}{3.5}{x 2 exp 4 mul}
        \psplot[linecolor=red, linewidth=1pt]{-3.5}{3.5}{x 2 exp 0.3 mul}
        \psplot[linecolor=green, linewidth=1pt]{-3.5}{3.5}{x 2 exp -1 mul}
        \uput[0](1.8,3){1}
        \uput[0](0.8,3){4}
        \uput[0](2,1){0.3}
        \uput[0](1.8,-3){-1}
    ...
    \subfigure[Parameter $b$.]{
      ...
      \begin{pspicture*}(-3.5,-3.5)(3.5,3.5)
        \psaxes[labels=none]{->}(0,0)(-3.5,-3.5)(3.5,3.5)
        \psplot[linecolor=black, linewidth=1pt]{-3.5}{3.5}{x 3 exp}
        \psplot[linecolor=blue, linewidth=1pt]{-3.5}{3.5}{x 2.5 div 3 exp}
        \psplot[linecolor=red, linewidth=1pt]{-3.5}{3.5}{x 0.3 div 3 exp}
        \psplot[linecolor=green, linewidth=1pt]{-3.5}{3.5}{x -1 div 3 exp}
        \uput[0](1.5,3){$1$}
        \uput[0](0.4,3){$0.3$}
        \uput[0](2.5,1){$2.5$}
        \uput[0](-1.5,3){$-1$}
  ...
  \begin{center}
    \subfigure[Snop premic.]{
      ...
      \begin{pspicture*}(-2.0,-2.0)(2.0,2.0)
        ...
        \psplot[linecolor=black, linewidth=1pt]{-2.0}{2.0}{x}
        \psplot[linecolor=black, linewidth=1pt]{-2.0}{2.0}{x 2 sub}
        \psplot[linecolor=black, linewidth=1pt]{-2.0}{2.0}{x 0.5 add}
        \psplot[linecolor=black, linewidth=1pt]{-2.0}{2.0}{x 1.5 add}
      \end{pspicture*}
    }
    \subfigure[Šop premic.]{
      ...
      \begin{pspicture*}(-2.0,-2.0)(2.0,2.0)
        \psaxes[labels=none]{->}(0,0)(-2.0,-2.0)(2.0,2.0)
        \psplot[linecolor=black, linewidth=1pt]{-2.0}{2.0}{x 0.5 add}
        \psplot[linecolor=black, linewidth=1pt]{-2.5}{2.5}{x 0.5 add 0.5 mul}
        \psplot[linecolor=black, linewidth=1pt]{-2.5}{2.5}{x 0.5 add -2 mul}
        \psplot[linecolor=black, linewidth=1pt]{-2.5}{2.5}{x 0.5 add -0.5 mul}
      \end{pspicture*}
    }
  \end{center}
  ...
  \begin{center}
    \subfigure[Pozitiven sod eksponent]{
      ...
      \begin{pspicture*}(-2.2,-2.2)(2.2,2.2)
        ...
        \psplot[linecolor=black, linewidth=1pt]{-2.2}{2.2}{x 2 exp }
      \end{pspicture*}
    }
    \subfigure[Pozitiven lih eksponent]{
      ...
      \begin{pspicture*}(-2.2,-2.2)(2.2,2.2)
        \psaxes[labels=none]{->}(0,0)(-2.2,-2.2)(2.2,2.2)
        \psplot[linecolor=black, linewidth=1pt]{-2.2}{2.2}{x 3 exp }
      \end{pspicture*}
    } \\
    ...
    \subfigure[Negativen lih eksponent]{
      ...
      \begin{pspicture*}(-2.2,-2.2)(2.2,2.2)
        \psaxes[labels=none]{->}(0,0)(-2.2,-2.2)(2.2,2.2)
        \psplot[linecolor=black, linewidth=1pt]{-2.2}{-0.001}{x -1 exp }
        \psplot[linecolor=black, linewidth=1pt]{2.2}{0.001}{x -1 exp }
        \asimptota(-3,.05)(3,.05)
        \asimptota(.05,-3)(.05,3)
      \end{pspicture*}
...
\begin{figure}[h!t]
  \begin{center}
    \begin{pspicture*}(-3.5,-3.5)(3.5,3.5)
      \psaxes[labels=none]{->}(0,0)(-3.5,-3.5)(3.5,3.5)
      \psplot[linecolor=black, linewidth=1pt]{0}{3.5}{x sqrt}
      \psplot[linecolor=blue, linewidth=1pt, swapaxes=true]{-3.5}{3.5}{x 3 exp}
      \uput[-10](2,2){$\sqrt{x}$}
  ...
  \begin{center}
    ...
    \subfigure[a > 1]{
      ...
      \begin{pspicture*}(-4.9,-4.9)(4.9,4.9)
        ...
        \psplot[linecolor=red, linewidth=1pt]{-4.9}{4.9}{2.7182 x exp}
        \psplot[linecolor=blue, linewidth=1pt]{-4.9}{4.9}{1.5 x exp}
        \psplot[linecolor=green, linewidth=1pt]{-4.9}{4.9}{10 x exp}
        \uput[180](0,4.5){$10^x$}
        \uput[0](1.5,4.5){$e^x$}
    ...
    \subfigure[a < 1]{
      ...
      \begin{pspicture*}(-4.9,-4.9)(4.9,4.9)
        \psaxes[labels=none]{->}(0,0)(-4.9,-4.9)(4.9,4.9)
        \psplot[linecolor=red, linewidth=1pt]{-4.9}{4.9}{0.5 x exp}
        \psplot[linecolor=blue, linewidth=1pt]{-4.9}{4.9}{0.66666667 x exp}
        \psplot[linecolor=green, linewidth=1pt]{-4.9}{4.9}{0.1 x exp}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \subfigure[a > 1]{
      ...
      \begin{pspicture*}(-4.9,-4.9)(4.9,4.9)
        \psaxes[labels=none]{->}(0,0)(-4.9,-4.9)(4.9,4.9)
        \psplot[swapaxes=true, linecolor=red, linewidth=1pt]{-4.9}{4.9}{2.7182 x exp}
        \psplot[swapaxes=true, linecolor=blue, linewidth=1pt]{-4.9}{4.9}{1.5 x exp}
        \psplot[swapaxes=true, linecolor=green, linewidth=1pt]{-4.9}{4.9}{10 x exp}
    ...
    \subfigure[a < 1]{
      ...
      \begin{pspicture*}(-4.9,-4.9)(4.9,4.9)
        \psaxes[labels=none]{->}(0,0)(-4.9,-4.9)(4.9,4.9)
        \psplot[swapaxes=true, linecolor=red, linewidth=1pt]{-4.9}{4.9}{0.4 x exp}
        \psplot[swapaxes=true, linecolor=blue, linewidth=1pt]{-4.9}{4.9}{0.66666667 x exp}
        \psplot[swapaxes=true, linecolor=green, linewidth=1pt]{-4.9}{4.9}{0.1 x exp}
  ...
  \begin{center}
    ...
    \subfigure[Arcus sinus]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        ...
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{-1.5}{1.5}{x 60 mul sin}
        \oznaka(0,1.5)(1,1.5)
        \oznaka(0,-1.5)(-1,-1.5)
        \oznaka(-1,0)(-1,-1.5)
        \oznaka(1,0)(1,1.5)
    ...
    \subfigure[Arcus kosinus]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        ...
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{-1}{2}{x 1 add 60 mul cos}
        \oznaka(-1,-1)(-1,2)
        \oznaka(-1,2)(0,2)
        \uput[0](0,2){$\pi$}
        \uput[-90](1,-1){$1$}
    ...
    \subfigure[Arcus tangens]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        \psaxes[labels=none]{->}(0,0)(-2.5,-2.5)(2.5,2.5)
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{-1.4}{1.4}{x 60 mul sin x 60 mul cos div}
    ...
    \subfigure[Arcus kotangens]{
      ...
      \begin{pspicture*}(-2.5,-2.5)(2.5,2.5)
        \psaxes[labels=none]{->}(0,-1)(-2.5,-2.5)(2.5,2.5)
        \psplot[linecolor=black, linewidth=1pt,swapaxes=true]{-0.9}{1.9}{x 1 add 60 mul cos
...
Enačbi lahko na obeh straneh \textbf{prištejemo} ali \textbf{odštejemo} poljubno število ali izraz in se enakost ohrani.
Iz tega izhaja tudi ``prenašanje'' člena preko enačaja (na obeh straneh odštejemo ali
prištejemo ta člen).

Enačbo lahko na obeh straneh \textbf{množimo} ali \textbf{delimo} s poljubnim številom ali izrazom, ki ni
enak 0, in se enakost ohrani. 

Vse druge operacije (npr. logaritmiranje, potenciranje, korenjenje) \textbf{ne
privedejo} nujno do ekvivalentnih enačb!
...
\label{sec:enac:eks}
\textbf{Eksponentna enačba} je vsaka enačba v kateri nastopa neznanka v eksponentu.
...
v to obliko lahko prevedemo. Pomembno je, da si pri reševanju take enačbe zapišemo pogoje
...
Racionalna neenačba je vsaka neenačba oblike $\frac{p(x)}{q(x)} < 0$ ali
$\frac{p(x)}{q(x)} > 0$ ali vsaka neenačba, ki jo v to obliko lahko prevedemo. Rešimo jo
...
osi in nato izberemo želeni interval kot rešitev neenačbe.
